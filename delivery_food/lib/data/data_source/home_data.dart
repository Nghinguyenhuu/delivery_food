...
List<Restaurant> allRestaurant = [
   const Restaurant(assetImage: 'assets/images/Logo.png', deliveryTime: 12, id: 1, name: 'Herbal Pancake'),
   const Restaurant(assetImage: 'assets/images/Logo.png', deliveryTime: 12, id: 2, name: 'Herbal Pancake'),
   const Restaurant(assetImage: 'assets/images/Logo.png', deliveryTime: 12, id: 3, name: 'Herbal Pancake'),
   const Restaurant(assetImage: 'assets/images/Logo.png', deliveryTime: 12, id: 4, name: 'Herbal Pancake'),
];
