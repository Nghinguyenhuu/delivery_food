...
class AppColors {
  static const Color orange = Color(0xFFDA6317);
  static const Color gold = Color(0xFFFEAD1D);
  ...
  static const Color appLinerColorEnd = Color(0xFF15BE77);
  static const Color appInputTextColor = Color(0xFF3B3B3B) ;
}
